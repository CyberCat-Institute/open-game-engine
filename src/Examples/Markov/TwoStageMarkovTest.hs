...
-- Show output pathological end game with random strategy
-- NOTE this illustrates already that a random strategy can cause the blowup to happen
eqOutputDetermRandomStrat iterator = generateIsEq $ repeatedCompleteGameEqDeterm iterator strategyTupleRandom (Cooperate,Cooperate,False)
