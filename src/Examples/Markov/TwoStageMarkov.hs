...
determineContinuationPayoffs2 iterator strat action = do
  ...
  determineContinuationPayoffs (pred iterator) strat nextInput
  where
    executeStrat = play completeGame2 strat
