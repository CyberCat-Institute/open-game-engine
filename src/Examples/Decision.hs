...
singleDecisionVerbose actionSpace payoffFunction =
  [opengame|
   inputs    :      ;
   feedback  :      ;
...
-- Requires a list of actions, and a payoff function
singleDecisionReduced actionSpace payoffFunction =
  [opengame|
   operation : dependentDecision "player1" (const actionSpace);
   outputs   : decisionPlayer1 ;
   returns   : payoffFunction decisionPlayer1     ;
...
singleDecisionPriorVerbose actionSpace payoffFunction =
  [opengame|
   inputs    : x    ;
   feedback  :      ;
...
-- | The same decision in the reduced style, i.e. ignoring empty fields
-- Requires a list of actions, and a payoff function
singleDecisionPriorReduced actionSpace payoffFunction =
  [opengame|
   inputs    : x    ;
   :----------------------------:
   inputs    : x    ;
...
singleDecStoch distribution actionSpace payoffFunction =
  [opengame|
   inputs    :     ;
   feedback  :     ;
