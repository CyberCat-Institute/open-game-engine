...
branchingGame  = reindex (\x -> (x, ())) ((reindex (\x -> ((), x)) ((fromFunctions (\x -> x) (\(tech, vote1, vote2, discard', discard) -> ())) >>> (reindex (\(a1, a2, a3) -> ((a1, a2), a3)) (((reindex (\x -> (x, ())) ((reindex (\x -> ((), x)) ((fromFunctions (\() -> ((), ())) (\((tech, vote1, vote2, discard', discard), ()) -> (tech, vote1, vote2, discard', discard))) >>> (reindex (\x -> ((), x)) ((fromFunctions (\x -> x) (\x -> x)) &&& ((technology)))))) >>> (fromFunctions (\((), tech) -> tech) (\(tech, vote1, vote2, discard', discard) -> ((tech, vote1, vote2, discard', discard), ()))))) >>> (reindex (\x -> (x, ())) ((reindex (\x -> ((), x)) ((fromFunctions (\tech -> (tech, ())) (\((tech, vote1, vote2, discard', discard), ()) -> (tech, vote1, vote2, discard', discard))) >>> (reindex (\x -> ((), x)) ((fromFunctions (\x -> x) (\x -> x)) &&& ((votingInst)))))) >>> (fromFunctions (\(tech, (vote1, vote2)) -> (tech, vote1, vote2)) (\(tech, vote1, vote2, discard', discard) -> ((tech, vote1, vote2, discard', discard), ())))))) >>> (reindex (\x -> (x, ())) ((reindex (\x -> ((), x)) ((fromFunctions (\(tech, vote1, vote2) -> ((tech, vote1, vote2), majority tech vote1 vote2)) (\((tech, vote1, vote2, discard'), discard) -> (tech, vote1, vote2, discard', discard))) >>> (reindex (\x -> ((), x)) ((fromFunctions (\x -> x) (\x -> x)) &&& ((cropGame +++ wageGame)))))) >>> (fromFunctions (\((tech, vote1, vote2), discard') -> (tech, vote1, vote2, discard')) (\(tech, vote1, vote2, discard') -> ((tech, vote1, vote2, discard'), ()))))))))) >>> (fromLens (\(tech, vote1, vote2, discard') -> ()) (curry (\((tech, vote1, vote2, discard'), ()) -> (tech, vote1, vote2, discard'))))) 
...
randomInst = reindex (\x -> (x, ())) ((reindex (\x -> ((), x)) ((fromFunctions (\x -> x) (\(tech, inst, discard', discard) -> ())) >>> (reindex (\(a1, a2, a3) -> ((a1, a2), a3)) (((reindex (\x -> (x, ())) ((reindex (\x -> ((), x)) ((fromFunctions (\() -> ((), ())) (\((tech, inst, discard', discard), ()) -> (tech, inst, discard', discard))) >>> (reindex (\x -> ((), x)) ((fromFunctions (\x -> x) (\x -> x)) &&& ((technology)))))) >>> (fromFunctions (\((), tech) -> tech) (\(tech, inst, discard', discard) -> ((tech, inst, discard', discard), ()))))) >>> (reindex (\x -> (x, ())) ((reindex (\x -> ((), x)) ((fromFunctions (\tech -> (tech, ())) (\((tech, inst, discard', discard), ()) -> (tech, inst, discard', discard))) >>> (reindex (\x -> ((), x)) ((fromFunctions (\x -> x) (\x -> x)) &&& ((nature (uniform ["cr", "wa"]))))))) >>> (fromFunctions (\(tech, inst) -> (tech, inst)) (\(tech, inst, discard', discard) -> ((tech, inst, discard', discard), ())))))) >>> (reindex (\x -> (x, ())) ((reindex (\x -> ((), x)) ((fromFunctions (\(tech, inst) -> ((tech, inst), regimeChoice tech inst)) (\((tech, inst, discard'), discard) -> (tech, inst, discard', discard))) >>> (reindex (\x -> ((), x)) ((fromFunctions (\x -> x) (\x -> x)) &&& ((cropGame +++ wageGame )))))) >>> (fromFunctions (\((tech, inst), discard') -> (tech, inst, discard')) (\(tech, inst, discard') -> ((tech, inst, discard'), ()))))))))) >>> (fromLens (\(tech, inst, discard') -> ()) (curry (\((tech, inst, discard'), ()) -> (tech, inst, discard')))))
