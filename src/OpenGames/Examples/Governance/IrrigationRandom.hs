...
irrigationMonitorP1Src = Block [] []
  [Line Nothing ["\"farmer1\"", "[Work, Shirk]", "()"] [] "dependentDecision" ["monitorWorks"] ["monitorPayoff 0 0 0 monitorWorks"],
   ...
   Line Nothing ["\"farmer1\"", "levelAfter3", "monitorWorks"] [] "irrigationStepMonitorNoTax" ["levelAfter4"] []]
  [] []
...
irrigationMonitorP2Src = Block [] []
  [Line Nothing ["\"farmer2\"", "[Work, Shirk]", "()"] [] "dependentDecision" ["monitorWorks"] ["monitorPayoff 0 0 0 monitorWorks"],
   ...
   Line Nothing ["\"farmer2\"", "levelAfter1", "monitorWorks"] [] "irrigationStepMonitorNoTax" ["levelAfter2"] [],
   Line Nothing ["\"farmer3\"", "levelAfter2", "monitorWorks"] [] "irrigationStepMonitorNoTax" ["levelAfter3"] [],
   Line Nothing ["\"farmer2\"", "levelAfter3", "monitorWorks"] [] "irrigationStepMonitorNoTax" ["levelAfter4"] []]
  [] []
...
irrigationMonitorP3Src = Block [] []
  [Line Nothing ["\"farmer3\"", "[Work, Shirk]", "()"] [] "dependentDecision" ["monitorWorks"] ["monitorPayoff 0 0 0 monitorWorks"],
   ...
   Line Nothing ["\"farmer2\"", "levelAfter1", "monitorWorks"] [] "irrigationStepMonitorNoTax" ["levelAfter2"] [],
   Line Nothing ["\"farmer3\"", "levelAfter2", "monitorWorks"] [] "irrigationStepMonitorNoTax" ["levelAfter3"] [],
   Line Nothing ["\"farmer3\"", "levelAfter3", "monitorWorks"] [] "irrigationStepMonitorNoTax" ["levelAfter4"] []]
  [] []
...
irrigationRandomMonitorSrc = Block [] []
  [Line Nothing [] [] "nature (uniform [Left (Left ()), Left (Right ()), Right ()])" ["switch"] [],
   Line Nothing ["switch"] [] "irrigationMonitorP1 +++ irrigationMonitorP2 +++ irrigationMonitorP3" ["discard"] []]
  [] []
