...
generateGame "firstPriceAuctionTH" []
                           [mkLine [] [] [|nature (uniform [0..6])|] ["t1"] [],
                            mkLine [] [] [|nature (uniform [0..6])|] ["t2"] [],
                            mkLine [[|t1|]] [] [|decision "player1" [0..12]|] ["x"] [[|playerOneUtility t1 x y|]],
                            mkLine [[|t2|]] [] [|decision "player2" [0..12]|] ["y"] [[|playerTwoUtility t2 x y|]]]
...
generateGame "secondPriceAuctionTH" [] $
                           [mkLine [] [] [|nature (uniform [0..6])|] ["t1"] [],
                            mkLine [] [] [|nature (uniform [0..6])|] ["t2"] [],
                            mkLine [param "t1"] [] [|decision "player1" [0..12]|] ["x"] [[|playerOneUtility2nd t1 x y|]],
                            mkLine [param "t2"] [] [|decision "player2" [0..12]|] ["y"] [[|playerTwoUtility2nd t2 x y|]]]
...
secondPriceAuctionSrc = Block [] []
                           [mkLine [] [] "nature (uniform [0..6])" ["t1"] [],
                            mkLine [] [] "nature (uniform [0..6])" ["t2"] [],
                            mkLine ["t1"] [] "decision \"player1\" [0..12]" ["x"] ["playerOneUtility2nd t1 x y"],
                            mkLine ["t2"] [] "decision \"player2\" [0..12]" ["y"] ["playerTwoUtility2nd t2 x y"]]
                           [] []
...
generateGame "firstPriceCommonValuationTH" [] $
  [mkLine [] []           [|nature (uniform [10..16])|] ["t"] [],
   mkLine [] []           [|nature (uniform [10..16])|] ["s1"] [],
   mkLine [] []           [|nature (uniform [10..16])|] ["s2"] [],
   mkLine [] []           [|nature (uniform [False, True])|] ["tieFavoursOne"] [],
   mkLine [[|t + s1|]] [] [|decision "player1" [20..32]|] ["x"] [[|playerOneUtility_correlated t s1 s2 x y tieFavoursOne|]],
   mkLine [[|t + s2|]] [] [|decision "player2" [20..32]|] ["y"] [[|playerTwoUtility_correlated t s1 s2 x y tieFavoursOne|]]]
...
generateGame "discreteAuctionTH" [] $
   [mkLine []           [] [|nature discreteAuctionPrior|]       ["t1", "t2", "flip'"] [],
    mkLine [param "t1"] [] [|decision "player1" [Ten, Hundred]|] ["x"] [[|discreteAuctionUtility1 t1 x y flip'|]],
    mkLine [param "t2"] [] [|decision "player2" [Ten, Hundred]|] ["y"] [[|discreteAuctionUtility2 t2 x y flip'|]]
   ]
