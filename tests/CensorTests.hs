...
generateGame "fullCensorGameTH" ["censorPenalty"] $ GBlock [] []
  [QLine [[|0.05|]] [] [|depositGameTH|] ["daveStake", "erikaStake", "frankStake"] [],
   QLine (map param ["daveStake", "erikaStake", "frankStake"] ++ [[|0|]]) [] [|censorGameTH censorPenalty|] ["daveMove"] []]
  [] []
...
generateGame "bribeGameTH" [] $ GBlock ["target", "move", "bribe"] []
